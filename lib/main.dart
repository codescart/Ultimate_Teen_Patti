...
import 'package:ultimate_teen_patti/HomePage/splashscreen.dart';
import 'package:ultimate_teen_patti/loginscreen.dart';
import 'package:ultimate_teen_patti/registrationscreen.dart';
import 'package:ultimate_teen_patti/transation/slide_show.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:
      // ButtonTransform2Page(),
      // Borderanimate(child: Text('pj'),milisecond: 5000,),
      Splash_screen(),
    );
  }
}
